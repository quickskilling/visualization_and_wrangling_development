...
## Task 1: Understanding Graphical Perception
...
Specifically, in this case study you will get 5 - 10 ticker symbols and will need to build visualizations quickly that allows you to answer questions about the stocks in a few seconds. Get the historical financial data using the `yfinance` library.[Details](weekly_projects/cs09_details.html)
...
You can recreate [CS 10](https://quickskilling.github.io/visualization_and_wrangling_development/qmd_files/modules_files/weekly_projects/cs10_details.html){target="blank"} or find your own spatial data to display using [folium](https://python-visualization.github.io/folium/latest/index.html){target="blank"}.
