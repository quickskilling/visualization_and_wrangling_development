...
Choose from [Task 19](../qmd_files/modules_files/class_tasks/task19_details.html) or [Task 20](../qmd_files/modules_files/class_tasks/task20_details.html) and recreate your plot using [folium](https://python-visualization.github.io/folium/latest/index.html){target="blank"}
...
You can recreate [CS 10](../qmd_files/modules_files/weekly_projects/cs10_details.html){target="blank"} or find your own spatial data to display using [folium](https://python-visualization.github.io/folium/latest/index.html){target="blank"}.
